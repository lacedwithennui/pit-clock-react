...
export function teamRankLookup(teamKey: string, allStatuses: object): number {
    return (allStatuses === null || allStatuses === undefined || allStatuses[teamKey]["qual"] === null || allStatuses[teamKey]["qual"] === undefined || allStatuses[teamKey]["qual"]["ranking"]["rank"] === null || allStatuses[teamKey]["qual"]["ranking"]["rank"] === undefined) ? 0 : allStatuses[teamKey]["qual"]["ranking"]["rank"];
}

export function teamObjectRankLookup(teamStatus: object): number {
    return (teamStatus === null || teamStatus === undefined || teamStatus["qual"] === null || teamStatus["qual"] === undefined || teamStatus["qual"]["ranking"]["rank"] === null || teamStatus["qual"]["ranking"]["rank"] === undefined) ? 0 : teamStatus["qual"]["ranking"]["rank"];
}
